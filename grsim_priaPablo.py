...
if __name__=="__main__":
    ...
    while not rospy.is_shutdown():
        ...
        #msg_goalkeeper = SSL()
        distance_arco = math.sqrt((-4500 - goalkeeper_x)**2 + (0 - goalkeeper_y)**2)
        if ball_x > -1500 and distance_ball> 1000 :
            # Si la pelota esta lejos del golero y del arco el golero va a su posicion inicial
            #goal_x = -4500
            #goal_y = 0
            goal_angle = math.atan2(0- goalkeeper_y, -4500 - goalkeeper_x)
